...
#SBATCH --output=/home/akalout/Two_inclusions_wavelets/results/job%j.out
#SBATCH --error=/home/akalout/Two_inclusions_wavelets/results/job%j.err
...
python3 run_two_inclusions_wavelets_BC.py
