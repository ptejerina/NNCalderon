...
case = "horizontal_split_wavelets"
noise_str = "0pct"
noise_val = 0.0
...
data_filepath = os.path.join(
    current_dir,
    "data_horizontal_split_BC_wavelets",
    f"dtn_data_{case}.npz"
)

saving_path = os.path.join(
    current_dir,'data_horizontal_split_BC_wavelets', 'neww')
...
checkpoint_path = os.path.join(current_dir, "data_horizontal_split_BC_wavelets", "NN_epochs_161000")
