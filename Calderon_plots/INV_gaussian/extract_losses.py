...
path = "data_inverted_gaussian_shifted_wavelets/NN_epochs_161000"
...
# txt output path
txt_path = os.path.join(os.path.dirname(path), "losses_epoch_161000.txt")

with open(txt_path, "w") as f:
    f.write("Loss values for NN_epochs_161000\n")
    f.write("=" * 40 + "\n\n")
