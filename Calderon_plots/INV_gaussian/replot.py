...
case = "inverted_gaussian_shifted_wavelets"
noise_str = "0pct"
noise_val = 0.0
...
data_filepath = os.path.join(
    current_dir,
    "data_inverted_gaussian_shifted_wavelets",
    f"dtn_data_{case}.npz"
)

saving_path = os.path.join(
    current_dir,'data_inverted_gaussian_shifted_wavelets', 'neww')
...
checkpoint_path = os.path.join(current_dir, "data_inverted_gaussian_shifted_wavelets", "NN_epochs_161000")
