...
saving_path = os.path.dirname(data_filepath) + f'/est_2_results_{case}_{num_BC}_BC_{BC_type}_seed_{seed}_samp_{CONFIG["sampling_method"]}_{CONFIG['loss_weights']['dirichlet_bc']}_DBC'
