...
#SBATCH --output=/home/akalout/Single_inclusion_wavelets/results/job%j.out
#SBATCH --error=/home/akalout/Single_inclusion_wavelets/results/job%j.err
...
python3 run_single_inclusion_wavelets_BC_even.py
