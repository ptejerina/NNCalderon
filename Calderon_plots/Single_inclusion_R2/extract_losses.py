...
path = "data_single_inclusion_R2_BC_wavelets_orig/NN_epochs_537000"
...
# txt output path
txt_path = os.path.join(os.path.dirname(path), "losses_epoch_537000.txt")

with open(txt_path, "w") as f:
    f.write("Loss values for NN_epochs_537000\n")
    f.write("=" * 40 + "\n\n")
