...
saving_path = os.path.join(
    current_dir,'data_two_inclusions_BC_wavelets', 'neww_saved_scheduler')
...
checkpoint_path = os.path.join(current_dir, "data_two_inclusions_BC_wavelets", "NN_epochs_587000")
