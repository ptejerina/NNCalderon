...
path = "data_random_blobs_BC_wavelets/NN_epochs_400110"
...
# txt output path
txt_path = os.path.join(os.path.dirname(path), "losses_epoch_400110.txt")

with open(txt_path, "w") as f:
    f.write("Loss values for NN_epochs_400110\n")
    f.write("=" * 40 + "\n\n")
