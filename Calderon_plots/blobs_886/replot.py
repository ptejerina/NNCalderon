...
data_filepath = os.path.join(
    current_dir,
    "data_random_blobs_BC_wavelets",
    f"dtn_data_{case}.npz"
)

saving_path = os.path.join(
    current_dir,'data_random_blobs_BC_wavelets', 'plots')
...
checkpoint_path = os.path.join(current_dir, "data_random_blobs_BC_wavelets", "NN_epochs_400200")
