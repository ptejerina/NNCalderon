...
path = "data_radially_sym_sine_BC_wavelets/NN_epochs_617000"
...
# txt output path
txt_path = os.path.join(os.path.dirname(path), "losses_epoch_617000.txt")

with open(txt_path, "w") as f:
    f.write("Loss values for NN_epochs_617000\n")
    f.write("=" * 40 + "\n\n")
