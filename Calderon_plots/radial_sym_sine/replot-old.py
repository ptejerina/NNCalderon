...
data_filepath = os.path.join(
    current_dir,
    "data_radially_sym_sine_BC_wavelets",
    f"dtn_data_{case}.npz"
)

saving_path = os.path.join(
    current_dir,'data_radially_sym_sine_BC_wavelets', 'old_plots')
...
checkpoint_path = os.path.join(current_dir, "data_radially_sym_sine_BC_wavelets", "NN_epochs_617000")
