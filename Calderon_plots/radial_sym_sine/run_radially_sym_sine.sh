#!/bin/bash
#SBATCH --job-name=symsine
#SBATCH --ntasks-per-node=1
#SBATCH --exclude=gn05,gn06
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=1
#SBATCH --mem=200G
#SBATCH --time=5-00:00:00
#SBATCH --partition=unlimited
#SBATCH --output=/home/akalout/Radially_sym_sine/results/job%j.out
#SBATCH --error=/home/akalout/Radially_sym_sine/results/job%j.err
