...
path = "data_turbulent_BC_wavelets/NN_epochs_400210"
...
# txt output path
txt_path = os.path.join(os.path.dirname(path), "losses_epoch_400210.txt")

with open(txt_path, "w") as f:
    f.write("Loss values for NN_epochs_400210\n")
    f.write("=" * 40 + "\n\n")
