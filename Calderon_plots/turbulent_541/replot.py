from NNCalderon_rutine_CLEAN_new import *
import os
import torch.nn as nn
import matplotlib.pyplot as plt

case = "random_turbulent"
noise_str = "0pct"
noise_val = 0.0
...
data_filepath = os.path.join(
    current_dir,
    "data_turbulent_BC_wavelets",
    f"dtn_data_{case}.npz"
)

saving_path = os.path.join(
    current_dir,'data_turbulent_BC_wavelets', 'plots')
...
checkpoint_path = os.path.join(current_dir, "data_turbulent_BC_wavelets", "NN_epochs_400210")
