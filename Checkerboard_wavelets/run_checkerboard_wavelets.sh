...
#SBATCH --output=/home/akalout/checkerboard_wavelets/results/job%j.out
#SBATCH --error=/home/akalout/checkerboard_wavelets/results/job%j.err
...
python3 run_checkerboard_wavelets_BCs.py
