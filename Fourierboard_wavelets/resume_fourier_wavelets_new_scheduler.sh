...
#SBATCH --output=/home/akalout/Fourierboard_wavelets/results/job%j.out
#SBATCH --error=/home/akalout/Fourierboard_wavelets/results/job%j.err
...
python3 resume_fourierboard_wavelets_BCs_new_scheduler.py
