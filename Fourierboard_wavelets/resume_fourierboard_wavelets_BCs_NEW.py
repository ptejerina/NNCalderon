...
old_saving_path = os.path.join(base_dir, "train_runs_Silu_new")
new_saving_path = os.path.join(base_dir, "train_runs_new_cont'd")
...
checkpoint_path = f"{old_saving_path}/NN_epochs_381000"
