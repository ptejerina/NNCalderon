...
#SBATCH --output=/home/akalout/Fourierboard_wavelets_narrower/results/job%j.out
#SBATCH --error=/home/akalout/Fourierboard_wavelets_narrower/results/job%j.err
...
python3 run_fourierboard_wavelets_BCs_narrower.py
