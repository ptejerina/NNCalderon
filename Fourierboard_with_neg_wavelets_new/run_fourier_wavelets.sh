#!/bin/bash
#SBATCH --job-name=fourierboard
#SBATCH --ntasks-per-node=1
#SBATCH --exclude=gn04,gn06
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=1
#SBATCH --mem=200G
#SBATCH --time=5-00:00:00
#SBATCH --partition=unlimited
#SBATCH --output=/home/akalout/Fourierboard_with_neg_wavelets_new/results/job%j.out
#SBATCH --error=/home/akalout/Fourierboard_with_neg_wavelets_new/results/job%j.err
...
python3 run_fourierboard_wavelets_BCs.py
