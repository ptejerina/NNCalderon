...
#SBATCH --output=/home/akalout/CALDERON_PINNS/Heart_lungs/results/job%j.out
#SBATCH --error=/home/akalout/CALDERON_PINNS/Heart_lungs/results/job%j.err
...
python3 run_EIT_wavelets_BC.py
