...
#SBATCH --output=/home/akalout/Horizontal_split_Gaussian_BC/results/job%j.out
#SBATCH --error=/home/akalout/Horizontal_split_Gaussian_BC/results/job%j.err
...
python3 run_horizontal_split_Gaussian_BC.py
