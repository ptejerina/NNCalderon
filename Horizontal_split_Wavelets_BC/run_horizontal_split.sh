#!/bin/bash
#SBATCH --job-name=Horizontal_split_Gaussian_BC
...
#SBATCH --output=/home/akalout/Horizontal_split_Wavelets_BC/results/job%j.out
#SBATCH --error=/home/akalout/Horizontal_split_Wavelets_BC/results/job%j.err
...
python3 run_horizontal_split_wavelets_BC.py
