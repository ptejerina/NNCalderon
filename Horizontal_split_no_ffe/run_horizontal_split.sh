...
#SBATCH --output=/home/akalout/CALDERON_PINNS/Horizontal_split_no_ffe/results/job%j.out
#SBATCH --error=/home/akalout/CALDERON_PINNS/Horizontal_split_no_ffe/results/job%j.err
...
python3 run_horizontal_split_no_ffe.py
