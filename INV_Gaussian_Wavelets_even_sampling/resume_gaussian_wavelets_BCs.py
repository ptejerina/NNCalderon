...
CASES = ["inverted_gaussian_well_wavelets"]
...
for case in CASES:
    for noise_str, noise_val in NOISE_LEVELS.items():
        ...
        data_filepath = os.path.join(
            current_dir,
            "data_inverted_gaussian_wavelets",
            "dtn_data_random_" + case + ".npz"
        )
...
new_saving_path = os.path.join(base_dir, "train_runs_Silu_cont'd")
...
checkpoint_path = f"{old_saving_path}/NN_epochs_141000"
