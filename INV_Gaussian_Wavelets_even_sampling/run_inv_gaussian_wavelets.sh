...
#SBATCH --output=/home/akalout/INV_Gaussian_Wavelets_even_sampling/results/job%j.out
#SBATCH --error=/home/akalout/INV_Gaussian_Wavelets_even_sampling/results/job%j.err
...
python3 run_inv_gaussian_100waveletsBC.py
