...
#SBATCH --output=/home/akalout/INV_Gaussian_even_sampling_wider/results/job%j.out
#SBATCH --error=/home/akalout/INV_Gaussian_even_sampling_wider/results/job%j.err
