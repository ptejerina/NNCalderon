#!/bin/bash
#SBATCH --job-name=shifted_gaussian
...
#SBATCH --output=/home/akalout/INV_Gaussian_shifted_trig_BC/results/job%j.out
#SBATCH --error=/home/akalout/INV_Gaussian_shifted_trig_BC/results/job%j.err
...
python3 run_shifted_inv_gaussian_trig_BC.py
