#!/bin/bash
#SBATCH --job-name=shifted_gaussian_wavelets
...
#SBATCH --output=/home/akalout/INV_Gaussian_shifted_wavelets_BC/results/job%j.out
#SBATCH --error=/home/akalout/INV_Gaussian_shifted_wavelets_BC/results/job%j.err
...
python3 run_shifted_inv_gaussian_wavelets_BC.py
