...
from NNCalderon_rutine_Hminus1_norm import *
...
saving_path = os.path.dirname(data_filepath) + f'/test_1_results_{case}_{num_BC}_BC_{BC_type}_seed_{seed}_norm_{norm}'
