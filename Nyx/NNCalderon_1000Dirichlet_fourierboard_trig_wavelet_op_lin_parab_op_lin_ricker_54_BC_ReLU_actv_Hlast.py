...
from NNCalderon_rutine_choose_actv import *
...
saving_path = os.path.dirname(data_filepath) + '/test_7_ReLU_actv_Hlast_1000_Dirichlet'
...
CONFIG = {
    ...
    'u_net_layers': 6,
    'u_net_neurons': 256,
    'loss_weights': {'pde': 1.0, 'dirichlet_bc': 1000.0, 'neumann_bc': 10.0, 'force_true_gamma': 0.0} #, 'tv': 1e-4}
}
