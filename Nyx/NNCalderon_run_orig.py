...
CONFIG = {
    ...
    'u_net_layers': 6,
    'u_net_neurons': 128,
    'loss_weights': {'pde': 1.0, 'data': 5.0, 'force_true_gamma': 0.0, 'tv': 1e-4}
}
...
plt.close()
trainer.plot_boundary_data(dataset=dataset, save_fig=[0,5,10,15,20,25,30], show_fig=False)
plt.close()
trainer.plot_induced_potential_u(save_fig=[0,5,10,15,20,25,30], show_fig=False)
plt.close()
