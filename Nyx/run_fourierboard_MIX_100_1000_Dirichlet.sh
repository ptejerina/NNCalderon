#!/bin/bash
#SBATCH --job-name=DirichFourBoard
...
python3 NNCalderon_continue_100Dirichlet_fourierboard_trig_wavelet_op_lin_parab_op_lin_ricker_54_BC_ReLU_actv_Hlast.py &
python3 NNCalderon_1000Dirichlet_fourierboard_trig_wavelet_op_lin_parab_op_lin_ricker_54_BC_ReLU_actv_Hlast.py
