...
from NNCalderon_rutine_speed_test_cpu import *
...
for _ in range(reps):
    ...
    plt.close()
    trainer.plot_boundary_data(dataset=dataset, save_fig=False, show_fig=False)
    plt.close()
    trainer.plot_induced_potential_u(save_fig=False, show_fig=False)
    plt.close()
    trainer.plot_residuals(save_fig=False, show_fig=False)
