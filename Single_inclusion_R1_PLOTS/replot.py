...
data_filepath = os.path.join(
    current_dir,
    "data_single_inclusion_BC_wavelets_orig",
    f"dtn_data_{case}.npz"
)

saving_path = os.path.join(
    current_dir,'data_single_inclusion_BC_wavelets_orig', 'neww')
...
checkpoint_path = os.path.join(current_dir, "data_single_inclusion_BC_wavelets_orig", "NN_epochs_291000")
