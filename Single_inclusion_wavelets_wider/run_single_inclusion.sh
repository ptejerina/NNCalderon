#!/bin/bash
#SBATCH --job-name=inclusion_wavelets
...
#SBATCH --output=/home/akalout/Single_inclusion_wavelets_wider/results/job%j.out
#SBATCH --error=/home/akalout/Single_inclusion_wavelets_wider/results/job%j.err
...
python3 run_single_inclusion_wavelets_wider.py
